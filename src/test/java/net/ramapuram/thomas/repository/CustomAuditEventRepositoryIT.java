package net.ramapuram.thomas.repository;

import net.ramapuram.thomas.PmsApp;
import net.ramapuram.thomas.config.Constants;
import net.ramapuram.thomas.config.audit.AuditEventConverter;
import net.ramapuram.thomas.domain.PersistentAuditEvent;
...
import static net.ramapuram.thomas.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
